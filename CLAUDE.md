...
This is a **Claude Code plugin marketplace**: 55 plugins composed of 250 Agent Skills,
...
2. **Verify** — installs that exact version from TestPyPI and asserts all 250 skills land.
