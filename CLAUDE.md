...
This is a **Claude Code plugin marketplace**: 84 plugins composed of 398 Agent Skills,
...
2. **Verify** — installs that exact version from TestPyPI and asserts all 398 skills land.
