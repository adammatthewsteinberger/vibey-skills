...
This is a **Claude Code plugin marketplace**: 126 plugins composed of 640 Agent Skills,
...
2. **Verify** — installs that exact version from TestPyPI and asserts all 640 skills land.
