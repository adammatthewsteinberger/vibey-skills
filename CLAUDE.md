...
This is a **Claude Code plugin marketplace**: 117 plugins composed of 586 Agent Skills,
...
2. **Verify** — installs that exact version from TestPyPI and asserts all 586 skills land.
