...
This is a **Claude Code plugin marketplace**: 47 plugins composed of 210 Agent Skills,
...
2. **Verify** — installs that exact version from TestPyPI and asserts all 210 skills land.
