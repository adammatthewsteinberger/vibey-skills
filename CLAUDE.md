...
This is a **Claude Code plugin marketplace**: 79 plugins composed of 372 Agent Skills,
...
2. **Verify** — installs that exact version from TestPyPI and asserts all 372 skills land.
