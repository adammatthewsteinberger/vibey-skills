...
```bash
vibey-skills install --all                        # all 586 skills
...
vibey-skills: copied 586 skill(s) into /Users/you/.claude/skills

$ vibey-skills install --all
vibey-skills: 586 skill(s) already present, skipped: agile-delivery, ...
