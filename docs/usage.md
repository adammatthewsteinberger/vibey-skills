...
```bash
vibey-skills install --all                        # all 140 skills
...
vibey-skills: copied 140 skill(s) into /Users/you/.claude/skills

$ vibey-skills install --all
vibey-skills: 140 skill(s) already present, skipped: agile-delivery, ...
