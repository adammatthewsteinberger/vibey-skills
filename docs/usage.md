...
```bash
vibey-skills install --all                        # all 250 skills
...
vibey-skills: copied 250 skill(s) into /Users/you/.claude/skills

$ vibey-skills install --all
vibey-skills: 250 skill(s) already present, skipped: agile-delivery, ...
