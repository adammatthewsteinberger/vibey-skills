...
```bash
vibey-skills install --all                        # all 280 skills
...
vibey-skills: copied 280 skill(s) into /Users/you/.claude/skills

$ vibey-skills install --all
vibey-skills: 280 skill(s) already present, skipped: agile-delivery, ...
