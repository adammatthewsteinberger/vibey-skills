...
```bash
vibey-skills install --all                        # all 640 skills
...
vibey-skills: copied 640 skill(s) into /Users/you/.claude/skills

$ vibey-skills install --all
vibey-skills: 640 skill(s) already present, skipped: agile-delivery, ...
