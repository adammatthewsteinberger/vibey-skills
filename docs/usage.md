...
```bash
vibey-skills install --all                        # all 210 skills
...
vibey-skills: copied 210 skill(s) into /Users/you/.claude/skills

$ vibey-skills install --all
vibey-skills: 210 skill(s) already present, skipped: agile-delivery, ...
