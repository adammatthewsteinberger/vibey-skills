...
```bash
vibey-skills install --all                        # all 497 skills
...
vibey-skills: copied 497 skill(s) into /Users/you/.claude/skills

$ vibey-skills install --all
vibey-skills: 497 skill(s) already present, skipped: agile-delivery, ...
